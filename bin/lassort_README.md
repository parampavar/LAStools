...
-level [n]       : for files created by lastile sort into points into a subtiling with [n] levels  
-levels [n]      : for files created by lastile sort into points into a subtiling with [n] levels  
-point_source    : sort points based on their point source ID (usually the flightline number)  
-point_source_id : sort points based on their point source ID (usually the flightline number)  
...
-user_data       : sort by user data field  
