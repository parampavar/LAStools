...
## Examples
    ...
    blast2dem -i ..\data\TO_core_last_zoom.laz -o dem.png -v -utm 17T -hillshade
    blast2dem -i ..\data\TO_core_last_zoom.laz -o dem.png -v -utm 17T -hillshade -light 0 0 1
    blast2dem -i ..\data\TO_core_last_zoom.laz -o dem.png -v -utm 17T -gray
...
-grid [n]                  : raster with stepsize [n] {default 1}  
-grid_spacing [n]          : raster with stepsize [n] {default 1}  
...
-kill [n]                  : do not raster triangles with edges longer than [n] units  
...
-scale [n]                 : multiply all elevation values by [n] before rastering  
-set_min_max [min] [max]   : set range of [min] - [max] for -gray and -false  
