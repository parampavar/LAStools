...
This tool modifies points within a certain distance of polylines.
...
## see also
lasclip - modify LAS/LAZ based on distance from SHP polygons. 2D only.
lasdistance - modify LAS/LAZ based on distance from polygonal segments. Distance by 2D grid.
